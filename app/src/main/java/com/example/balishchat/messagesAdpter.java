...
import static com.example.balishchat.chatwindo.reciverIImg;
import static com.example.balishchat.chatwindo.senderImg;
...
public class messagesAdpter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == ITEM_SEND){
            View view = LayoutInflater.from(context).inflate(R.layout.sendor_layout, parent, false);
